...
class DataGouvFr(object):
    ...
    def __init__(self, api_key=environ.get("DATAGOUV_API_KEY", None)):
        ...
        if api_key:
            ...
            logger.warning("No API key. It won't be possible to write datasets."
                           "To get your API key: https://www.data.gouv.fr/fr/admin/me/#apikey")
    ...
    def get_organization(self, org_name="isogeo", x_fields=None):
        """TO DOC"""
        # handling request parameters
        ...
        # search request
        # head = {"X-API-KEY": self.api_key}
        search_url = "{}organizations/{}/".format(self.base_url, org_name)
...
if __name__ == '__main__':
    ...
    app = DataGouvFr(api_key=api_key)
    # print(dir(app))
    # print(app.get_organization("paris").get("id"))

    org_ds = app.org_datasets(org_id=orgas.get("paris"))
    print(org_ds.get("total"), org_ds.get("data")[0].keys(), org_ds.get("data")[0].get("spatial"))

    # if not org_ds.get("total"):
    #     exit("This organization has no published dataset.")
